"""Tool-level tests for the catalogue behind get_message_effect.

Everything here is about the cached catalogue itself: when it is revalidated,
what an unknown ID costs, how a stale file reference forces one hard refresh,
how the negative cache dies with the snapshot, and how accounts stay apart. The
asset ladder those catalogues feed is covered in test_effects_tool_assets.py.
"""
...
from helpers_effects import _ToolClient, _call, _payload, _use

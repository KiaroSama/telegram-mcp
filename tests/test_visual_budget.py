...
before any frame is decoded. An uninterruptible native render is a PROCESS, not
a thread, which is why these tests watch children rather than futures.
"""
...
from helpers_visual import _animated_gif, _animated_tgs, _transparent_vp9

...
# The OS port moved next door; re-exported because tests subclass
# `handles.SystemCalls` and several modules import it from here.
from telegram_mcp.syscalls import (  # noqa: F401  (re-exported)
    _REPARSE_POINT,
    SystemCalls,
)
